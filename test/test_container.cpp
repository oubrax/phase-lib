...
TEST_CASE("measure_pass container exact sizing") {
    Container c = Container(pad(10.), w(px(50.)), h(px(50.)));
...
TEST_CASE("measure_pass container fit sizing") {
    Container c = Container(child(Container(w(px(17.)), h(px(28.)))));
...
TEST_CASE("arrange_pass padded") {
    Container c = Container(pad(5.), child(Container(w(px(20.)), h(px(20.)))));
...
TEST_CASE("nested fit") {
    ...
    Container c = Container(child(Container(Container(Container(w(px(50.)), h(px(50.)))))));
...
TEST_CASE("nested grow") {
    Container c = Container(w(px(100.)), h(px(100.)),
                            child(Container(w(grow()), child(Container(w(grow()))))));
    c.measure();
    c.arrange();
...
TEST_CASE("percent sizing") {
    Container c = Container(w(px(100.)), h(px(100.)), child(Container(w(pct(50)), h(pct(50)))));
    c.measure();
    c.arrange();
...
TEST_CASE("nested percent sizing") {
    Container c = Container(
        w(px(200.)), h(px(200.)),
        child(Container(w(pct(50)), h(pct(50)), child(Container(w(pct(50)), h(pct(50)))))));
    c.measure();
    c.arrange();
...
TEST_CASE("align & cross alignment") {
    Container c =
        Container(w(px(100.)), h(px(100.)), pad(10.), gap(10.), main_align(ContainerAlign::Center),
                  cross_align(ContainerAlign::Center), child(Container(w(px(10.)), h(px(10.)))),
                  child(Container(w(px(10.)), h(px(10.)))));
